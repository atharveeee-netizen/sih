  ...
  const defaultSteps: RouteStep[] = [
    {
      ...
      facility: "Registered Box Apiary #042",
      actor: "Registered Beekeeper",
      timestamp: "18 Aug 2026, 06:30 AM IST",
      action: "Raw honey extracted, gravity filtered, and sealed with QR Code Tag #7721",
    ...
    },
    {
      ...
      location: "Regional Honey Processing Center, Patna (25.5941° N, 85.1376° E)",
      facility: "Cold Filtration & Moisture Stabilization Unit #3",
      actor: "Cooperative Field Officer",
    ...
    {
      stepNumber: 3,
      stageName: "Quality & Grading Check",
      location: "In-House Quality Testing Facility, New Delhi",
      facility: "FSSAI-Aligned Lab Test Bench (Moisture, HMF, Diastase, Brix)",
      actor: "Quality Testing Officer",
      timestamp: "21 Aug 2026, 11:45 AM IST",
      action: "Lab test recorded against FSSAI benchmark thresholds (moisture, HMF, diastase, brix); quality score computed and logged for on-chain grading",
    ...
    {
      stepNumber: 4,
      stageName: "QR Code Packaging & Dispensing",
      ...
      actor: "Automated QR Code Labeling Engine",
      timestamp: "23 Aug 2026, 04:20 PM IST",
      action: "QR code generated and printed on jar label, linked to the on-chain batch record",
    ...
    },
    {
      ...
      location: "Partner Retail Outlet, Connaught Place, New Delhi",
