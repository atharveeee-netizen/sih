...
| **IoT Range** | "15 km LoRa range guaranteed in all rural deployments." | [G] + [D] (Link Budget) | Theoretical link budget with SX1262 (+22 dBm, SF12, line-of-sight). Dense canopy or hilly terrain reduces range. | **"Sub-GHz LoRa (865 MHz IN) provides long-range telemetry designed for rural topography; effective field coverage spans 3–15 km depending on terrain and elevation."** |
